...
export default function Muffins() {
 const cakes = [
    ...
    { name: "Banana Cake", price: "₹30", img: bananaCakeImg },
    { name: "Almond Coconut Cake", price: "₹40", img: almondCoconutImg },
    { name: "Pineapple Cake", price: "₹32", img: pineappleCakeImg },
    {name: "Brownie", price: "₹75", img: brownieImg },
    {name:"Blondie", price: "₹80", img: blondeqImg }
  ];
   return (
    <div className="category-page">
      <h1 className="category-header">Muffins</h1>
